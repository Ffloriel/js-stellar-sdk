import URI$1 from 'urijs';
import { Account, xdr, Asset, StrKey } from 'stellar-base';
...
class AccountResponse {
    constructor(response) {
        this.baseAccount = new Account(response.account_id, response.sequence);
...
export { BadRequestError, BadResponseError, Config, FEDERATION_RESPONSE_MAX_SIZE, FederationServer, HorizonAxiosClient, NetworkError, NotFoundError, STELLAR_TOML_MAX_SIZE, Server, StellarTomlResolver };
