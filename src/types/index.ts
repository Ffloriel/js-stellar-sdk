...
export interface HorizonBaseResponse<T extends string = never> {
  _links: { [key in T | 'self']: HorizonResponseLink };
}

export interface HorizonTransactionResponse extends HorizonBaseResponse<
...
export interface HorizonBalanceLineAsset<
...
export type HorizonBalanceLine<T extends AssetType = AssetType> = T extends AssetType.native
  ? HorizonBalanceLineNative
  : T extends AssetType.credit4 | AssetType.credit12
  ? HorizonBalanceLineAsset<T>
  : HorizonBalanceLineNative | HorizonBalanceLineAsset;
...
enum HorizonOperationResponseType {
...
enum HorizonOperationResponseTypeI {
  createAccount = 0,
  payment = 1,
  pathPayment = 2,
...
interface HorizonBaseOperationResponse<
  T extends HorizonOperationResponseType = HorizonOperationResponseType,
  TI extends HorizonOperationResponseTypeI = HorizonOperationResponseTypeI
  > extends HorizonBaseResponse<'succeeds' | 'precedes' | 'effects' | 'transaction'> {
  id: string;
  paging_token: string;
  source_account: string;
  type: T;
...
interface HorizonCreateAccountOperationResponse
  extends HorizonBaseOperationResponse<
  HorizonOperationResponseType.createAccount,
  HorizonOperationResponseTypeI.createAccount
  > {
  account: string;
  funder: string;
...
interface HorizonPaymentOperationResponse
  extends HorizonBaseOperationResponse<
  HorizonOperationResponseType.payment,
  HorizonOperationResponseTypeI.payment
  > {
  from: string;
  to: string;
...
interface HorizonPathPaymentOperationResponse
  extends HorizonBaseOperationResponse<
  HorizonOperationResponseType.pathPayment,
  HorizonOperationResponseTypeI.pathPayment
  > {
  from: string;
  to: string;
  asset_type: AssetType;
...
interface HorizonManageOfferOperationResponse
  extends HorizonBaseOperationResponse<
  HorizonOperationResponseType.manageOffer,
  HorizonOperationResponseTypeI.manageOffer
  > {
  offer_id: number;
  amount: string;
...
interface HorizonPassiveOfferOperationResponse
  extends HorizonBaseOperationResponse<
  HorizonOperationResponseType.createPassiveOffer,
  HorizonOperationResponseTypeI.createPassiveOffer
  > {
  offer_id: number;
  amount: string;
  buying_asset_type: AssetType;
...
interface HorizonSetOptionsOperationResponse
  extends HorizonBaseOperationResponse<
  HorizonOperationResponseType.setOptions,
  HorizonOperationResponseTypeI.setOptions
  > {
  signer_key?: string;
...
interface HorizonChangeTrustOperationResponse
  extends HorizonBaseOperationResponse<
  HorizonOperationResponseType.changeTrust,
  HorizonOperationResponseTypeI.changeTrust
  > {
...
interface HorizonAllowTrustOperationResponse
  extends HorizonBaseOperationResponse<
  HorizonOperationResponseType.allowTrust,
  HorizonOperationResponseTypeI.allowTrust
  > {
  asset_type: AssetType;
  asset_code: string;
  asset_issuer: string;
...
interface HorizonAccountMergeOperationResponse
  extends HorizonBaseOperationResponse<
  HorizonOperationResponseType.accountMerge,
  HorizonOperationResponseTypeI.accountMerge
  > {
  into: string;
}

interface HorizonInflationOperationResponse
  extends HorizonBaseOperationResponse<
  HorizonOperationResponseType.inflation,
  HorizonOperationResponseTypeI.inflation
  > { }

interface HorizonManageDataOperationResponse
  extends HorizonBaseOperationResponse<
  HorizonOperationResponseType.manageData,
  HorizonOperationResponseTypeI.manageData
  > {
  name: string;
  value: Buffer;
}

interface HorizonBumpSequenceOperationResponse
  extends HorizonBaseOperationResponse<
  HorizonOperationResponseType.bumpSequence,
  HorizonOperationResponseTypeI.bumpSequence
  > {
  bump_to: string;
}
...
export interface HorizonTransactionResponseCollection
  extends HorizonResponseCollection<HorizonTransactionResponse> { }
...
export interface ServerCollectionPage<
  T extends HorizonBaseResponse = HorizonBaseResponse
  > {
  records: T[];
...
export interface ServerCollectionRecord<
  T extends HorizonBaseResponse = HorizonBaseResponse
  > {
  _links: {
    next: HorizonResponseLink;
...
export type ServerCallFunction<
  T extends HorizonBaseResponse = HorizonBaseResponse
  > = () => Promise<T>;

export type ServerCallCollectionFunction<
  T extends HorizonBaseResponse = HorizonBaseResponse
  > = (options?: ServerCallFunctionTemplateOptions) => Promise<ServerCollectionRecord<T>>;
...
export interface ServerBaseOperationRecord<
  T extends HorizonOperationResponseType = HorizonOperationResponseType,
  TI extends HorizonOperationResponseTypeI = HorizonOperationResponseTypeI
  > extends HorizonBaseOperationResponse<T, TI> {
...
export interface ServerCreateAccountOperationRecord
  extends ServerBaseOperationRecord<
  HorizonOperationResponseType.createAccount,
  HorizonOperationResponseTypeI.createAccount
  >,
  HorizonCreateAccountOperationResponse { }

export interface ServerPaymentOperationRecord
  extends ServerBaseOperationRecord<
  HorizonOperationResponseType.payment,
  HorizonOperationResponseTypeI.payment
  >,
  HorizonPaymentOperationResponse {
  sender: ServerCallFunction<ServerAccountRecord>;
  receiver: ServerCallFunction<ServerAccountRecord>;
}

export interface ServerPathPaymentOperationRecord
  extends ServerBaseOperationRecord<
  HorizonOperationResponseType.pathPayment,
  HorizonOperationResponseTypeI.pathPayment
  >,
  HorizonPathPaymentOperationResponse { }

export interface ServerManageOfferOperationRecord
  extends ServerBaseOperationRecord<
  HorizonOperationResponseType.manageOffer,
  HorizonOperationResponseTypeI.manageOffer
  >,
  HorizonManageOfferOperationResponse { }

export interface ServerPassiveOfferOperationRecord
  extends ServerBaseOperationRecord<
  HorizonOperationResponseType.createPassiveOffer,
  HorizonOperationResponseTypeI.createPassiveOffer
  >,
  HorizonPassiveOfferOperationResponse { }

export interface ServerSetOptionsOperationRecord
  extends ServerBaseOperationRecord<
  HorizonOperationResponseType.setOptions,
  HorizonOperationResponseTypeI.setOptions
  >,
  HorizonSetOptionsOperationResponse { }

export interface ServerChangeTrustOperationRecord
  extends ServerBaseOperationRecord<
  HorizonOperationResponseType.changeTrust,
  HorizonOperationResponseTypeI.changeTrust
  >,
  HorizonChangeTrustOperationResponse { }

export interface ServerAllowTrustOperationRecord
  extends ServerBaseOperationRecord<
  HorizonOperationResponseType.allowTrust,
  HorizonOperationResponseTypeI.allowTrust
  >,
  HorizonAllowTrustOperationResponse { }

export interface ServerAccountMergeOperationRecord
  extends ServerBaseOperationRecord<
  HorizonOperationResponseType.accountMerge,
  HorizonOperationResponseTypeI.accountMerge
  >,
  HorizonAccountMergeOperationResponse { }

export interface ServerInflationOperationRecord
  extends ServerBaseOperationRecord<
  HorizonOperationResponseType.inflation,
  HorizonOperationResponseTypeI.inflation
  >,
  HorizonInflationOperationResponse { }

export interface ServerManageDataOperationRecord
  extends ServerBaseOperationRecord<
  HorizonOperationResponseType.manageData,
  HorizonOperationResponseTypeI.manageData
  >,
  HorizonManageDataOperationResponse { }

interface ServerBumpSequenceOperationRecord
  extends ServerBaseOperationRecord<
  HorizonOperationResponseType.bumpSequence,
  HorizonOperationResponseTypeI.bumpSequence
  >,
  HorizonBumpSequenceOperationResponse { }

export type ServerOperationRecord =
  | ServerCreateAccountOperationRecord
  | ServerPaymentOperationRecord
  | ServerPathPaymentOperationRecord
  | ServerManageOfferOperationRecord
  | ServerPassiveOfferOperationRecord
  | ServerSetOptionsOperationRecord
  | ServerChangeTrustOperationRecord
  | ServerAllowTrustOperationRecord
  | ServerAccountMergeOperationRecord
  | ServerInflationOperationRecord
  | ServerManageDataOperationRecord
...
export interface ServerTransactionRecord
  extends Omit<HorizonTransactionResponse, 'ledger'> {
