...
export class FederationServer {
   ...
   */
  static resolve(value: string, opts: FederationServerOptions = {}) {
   ...
   */
  static createForDomain(domain: string, opts: FederationServerOptions = {}) {
